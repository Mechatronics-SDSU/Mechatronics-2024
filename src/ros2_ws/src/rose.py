...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        launch_ros.actions.Node(
            package='zed_orientation_node', executable='zed_orientation_exec', output='log',
            ),
        launch_ros.actions.Node(
            package='zed_pos_node', executable='zed_pos_exec', output='log',
            ),
        launch_ros.actions.Node(
            package='zed_vision_node', executable='zed_vision_exec', output='log',
            ),
        launch_ros.actions.Node(
